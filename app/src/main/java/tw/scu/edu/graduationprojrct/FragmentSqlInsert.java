...
public class FragmentSqlInsert extends Fragment {
    ...
    private static String DataBaseTable = "Personal_Profile";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.activity_enter, container, false);

        edit_Account = (EditText) view.findViewById(R.id.Account);
        ...
        btn_Insert = view.findViewById(R.id.login);
