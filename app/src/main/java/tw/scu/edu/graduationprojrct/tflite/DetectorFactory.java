package tw.scu.edu.graduationprojrct.tflite;
...
public class DetectorFactory {
    public static YoloV5Classifier getDetector(
        ...
        else if (modelFilename.equals("best-fp16s.tflite")) {
            labelFilename = "file:///android_asset/yolov7.txt";
            isQuantized = false;
            inputSize = 640;
        ...
        else if (modelFilename.equals("best-fp16m.tflite")) {
            labelFilename = "file:///android_asset/yolov7.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{40, 20, 10};
        ...
        else if (modelFilename.equals("best-fp16x.tflite")) {
            labelFilename = "file:///android_asset/yolov7.txt";
            isQuantized = false;
            inputSize = 640;
            output_width = new int[]{40, 20, 10};
